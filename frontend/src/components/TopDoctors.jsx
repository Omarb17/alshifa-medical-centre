...
const TopDoctors = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 mb-40 text-blue-5 md:mx-10">
      ...
      <div className="grid w-full gap-4 px-3 pt-5 grid-cols-auto gap-y-6 sm:px-0">
        {doctors.slice(0, 10).map((item, index) => (
          <div
            ...
            className="border border-blue-1 rounded-xl overflow-hidden cursor-pointer hover:translate-y-[-10px] hover:bg-blue-2 transition-all duration-500"
            key={index}
          >
            <img
